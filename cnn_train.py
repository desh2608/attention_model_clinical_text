...
class CNN_Train(object):
	...
	def __init__(self,num_classes, seq_len, att1_len, att2_len, label_dict_size, word_dict_size, pos_dict_size, d1_dict_size, d2_dict_size, type_dict_size, w_emb_size=50, d1_emb_size=5, d2_emb_size=5, pos_emb_size=5, type_emb_size=5, filter_sizes=[2,3,5], num_filters=70):
